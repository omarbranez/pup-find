class Puppy 
  ...
  attr_accessor :name, :breed, :age, :color_id, :picture, :sex, :size, :org_id, :descrip, :website, :user_zip
  @@all = []
  ...
  def puppy_bio #nils should be "Unknown"
    puts "***********************************************************************************************************************"
    ...
    puts "I am #{self.age} months old!"
    puts "My colors and markings are #{self.color_id}!" #split and comma'd if multiple, STILL NEED TO IMPLEMENT
